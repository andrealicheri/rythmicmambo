isTunnel: bool = False # Specifies if a tunneling service is used. This will remove the port on generated logger links
...
debugMode: bool = True # Sets Flask debug mode
